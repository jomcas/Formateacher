                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              inputFile(
                                  label: "Day:",
                                  validator: (val) =>
                                  val.isEmpty ? 'Please enter the upcoming day' : null,
                                  onChanged: (val) {
                                    setState(() {
                                      day = val;
                                    });
                              ...
                              inputFile(
                                  label: "Date:",
                                  validator: (val) =>
                                  val.isEmpty ? 'Please enter the upcoming date' : null,
                                  onChanged: (val) {
                                    setState(() {
                                      date = val;
                                    });
                    ...
                    SizedBox(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                            ...
                            ReminderFormat = "Good Day Students I just wanted to remind you about the meeting we have scheduled for $day $date at $time. That will be held using $platform, and we'll be discussing $purpose.";
                            Navigator.push(context, MaterialPageRoute(builder: (context) => PreviewPage(str: ReminderFormat)));
//                          Navigator.push(
//                            context,
